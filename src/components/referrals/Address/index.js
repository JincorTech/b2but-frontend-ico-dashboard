  ...
  render() {
    ...
    return (
      <div className={s.address}>
        ...
        Become a part of Export Online’s team and help us bring transparency and cost-efficiency
        to thousands of companies from all around the world. All you have to do is to tell
        your contacts about Export Online and invite them
        ...
        For more details, please email us directly at <a href="mailto:partners@export.online">partners@export.online</a> using the subject
        line "Export Online’s Partner Program"
        </div>
